...
// pop-up//
    ...
    document.querySelectorAll('.buy-now').forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Reset trạng thái của các nút kích thước
    ...
    // Xử lý nút MUA NGAY trong pop-up
    document.querySelector('.buy-now-popup').addEventListener('click', () => {
        if (!selectedSize) {
            alert('Vui lòng chọn kích thước trước khi mua!');
            return;
        }
        alert('Bạn đã chọn mua ngay sản phẩm: ' + popupTitle.textContent + ' - Kích thước: ' + selectedSize + '. Chuyển đến trang thanh toán!');
        closePopup();
    });

    // Xử lý nút THÊM VÀO GIỎ HÀNG trong pop-up
    document.querySelector('.add-to-cart-popup').addEventListener('click', () => {
        if (!selectedSize) {
            alert('Vui lòng chọn kích thước trước khi thêm vào giỏ hàng!');
            return;
        }
        alert('Sản phẩm: ' + popupTitle.textContent + ' - Kích thước: ' + selectedSize + ' đã được thêm vào giỏ hàng!');
        closePopup();
    });
